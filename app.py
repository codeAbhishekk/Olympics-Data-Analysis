...
if user_menu == 'Medal Tally':
    ...
    if medal_tally.empty:
        st.write("No data available for medal tally.")
    else:
        if selected_year == 'Overall' and selected_country == 'Overall':
            st.title("Overall Tally")
        if selected_year != 'Overall' and selected_country == 'Overall':
            st.title("Overall Olympics Medal Tally in " + str(selected_year))
        if selected_year == 'Overall' and selected_country != 'Overall':
...
if user_menu == 'Overall Analysis':
    ...
    fig = px.line(nations_over_time, x="Edition", y="region", title="Number of Participating Countries Over Time")
    st.plotly_chart(fig)
...
if user_menu == 'Country-wise Analysis':
    ...
    st.title("Top ten athletes of " + selected_country)
